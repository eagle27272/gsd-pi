 ...
 * repository or index — a server started from a git hook or from a shell that
 * pre-set GIT_DIR would otherwise resolve every path against that repo instead
 * of the directory it was asked about.
 *

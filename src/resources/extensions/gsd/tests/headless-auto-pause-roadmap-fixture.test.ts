// Project/App: gsd-pi
// File Purpose: #1774 fixture contract — a recovered ROADMAP must stay
// git-tracked and resolvable at its in-project path for pass-0 reconciliation
// (roadmap-missing flake).
...
test("#1774: tracked recovered ROADMAP stays resolvable at the in-project path", () => {

 ...
 *
 * Builds the themed renderers every screen draws with. The glyph, status and
 * spacing vocabulary they use lives in glyphs.js, which stays import-free so
 * shared/mod.ts can re-export it without pulling @gsd/pi-tui into the barrel.
 *
 * Usage:
 *
...
import { GLYPH, INDENT, STATUS_COLOR, STATUS_GLYPH, type ProgressStatus } from "./glyphs.js";
